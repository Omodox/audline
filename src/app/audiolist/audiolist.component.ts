...
export class AudiolistComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    (function(){
      ...
      var i=d[ce]('iframe');i[st][ds]=n;d[gi]("M403150ScriptRootC668348")[ac](i);try{var iw=i.contentWindow.document;iw.open();iw.writeln("<ht"+"ml><bo"+"dy></bo"+"dy></ht"+"ml>");iw.close();var c=iw[b];}
      catch(e){var iw=d;var c=d[gi]("M403150ScriptRootC668348");}var dv=iw[ce]('div');dv.id="MG_ID";dv[st][ds]=n;dv.innerHTML=668348;c[ac](dv);
      var s=iw[ce]('script');s.async='async';s.defer='defer';s.charset='utf-8';s.src=wp+"//jsc.marketgid.com/a/u/audline.net.668348.js?t="+D.getFullYear()+D.getMonth()+D.getUTCDate()+D.getUTCHours();c[ac](s);})();
